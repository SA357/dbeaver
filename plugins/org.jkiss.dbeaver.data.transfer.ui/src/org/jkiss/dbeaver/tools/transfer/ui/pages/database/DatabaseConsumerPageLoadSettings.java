...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, DTUIMessages.database_consumer_wizard_trunicate_checkbox_title, 
            		DTUIMessages.database_consumer_wizard_trunicate_checkbox_question_part_1 + 
            		tableNames + 
            		DTUIMessages.database_consumer_wizard_trunicate_checkbox_question_part_2))
            {
                return false;
            }
        }
